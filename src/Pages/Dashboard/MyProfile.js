            ...
            <div className="row align-items-center">
                ...
                <div className="col-sm-6">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mb-3">
                            <label htmlhtmlFor="education" className="form-label">Education</label>
                        ...
                        <div className="mb-3">
                            <label htmlhtmlFor="location" className="form-label">City/ District</label>
                        ...
                        <div className="mb-3">
                            <label htmlhtmlFor="number" className="form-label">Phone Number</label>
                        ...
                        <div className="mb-3">
                            <label htmlhtmlFor="linkedin" className="form-label">Linkedin</label>
